/* ── HAMBURGER MENU ─────────────────────── */
/* NOTE: hamburger/sidebar toggle is handled by the inline script on each
   page (next to #rafi-bar). Keeping a second handler here caused duplicate
   event bindings — clicking would open+close the drawer in the same tick. */
...
const locations = {
    kk13: {
        src: 'https://maps.google.com/maps?q=Puncak+Damansara+Condominium,+Jalan+Teratai,+PJU+6,+Petaling+Jaya&z=16&output=embed',
        label: 'Puncak Damansara · Petaling Jaya, Selangor'
    },
    pkb: {
