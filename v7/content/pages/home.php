...
<div class="d-flex justify-content-center">
    <div class="content">
        ...
        <p class="about-section">
            ...
            Science Society of the <a class="textlink" href="https://fsktm.um.edu.my/" target="_blank"
                rel="noopener">Faculty of Computer Science &amp; IT</a>, and
        ...
        <p class="about-section">
            Beyond that I lead as <span class="highlightv1">Head of Department</span> for the IDFEST Art Exhibition
            at Universiti Malaya, and I served as a <span class="highlightv1">Student Buddy</span> for FSKTM's
            Inbound Mobility Programme 2026, hosting Chulalongkorn University students in Kuala Lumpur. I've also
            worked on PPI Malaysia's <span class="highlightv1">LARAS</span> committee, coordinating transportation
            and field operations for events serving hundreds of participants.
        </p>
            ...
            <div class="d-flex flex-wrap justify-content-between">
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <div>
                        ...
                        <a class="d-flex align-items-center gap-1 textlink" href="https://fsktm.um.edu.my/"
        ...
        <div class="about-section">
            <div class="d-flex flex-wrap justify-content-between">
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <div>
                        <p><b>Student Buddy, Inbound Mobility Programme 2026</b></p>
                        <a class="d-flex align-items-center gap-1 textlink" href="https://fsktm.um.edu.my/"
                            target="_blank">Faculty of Computer Science &amp; Information Technology, Universiti
            ...
            Student Buddy and handled documentation for the whole programme, covering sessions and daily
            activities across all five days.
        </div>
        <br>
        ...
        <div class="about-section">
            ...
            <div class="horizontal">
                ...
                <a class="menu-item" id="infra"><span>Infrastructure</span></a>
